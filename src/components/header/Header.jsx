        ...
        <div style={num === 2 ? {backgroundImage: `url(${poster2})`, zIndex: '999', opacity: '1'} : num === 3 ? {backgroundImage: `url(${poster3})`, zIndex: '999', opacity: '1'} : num === 4 ? {backgroundImage: `url(${poster4})`, zIndex: '999', opacity: '1'} : {overflow: 'hidden'}} className="Header" >
            <div className="container">
                <nav>
                    ...
                    <div style={{overflow: 'scroll'}} id={menu === true ? 'sideBarChange' : 'sidebar'} className="sideBar">
                        <div style={{overflow: 'scroll'}} className="sideBar__row">
                        ...
                        </div>
                        {
                            moviee && moviee.map((item, index) => {
                                if( item.status == true) {
                                    return (
                                        <div key={index} style={{overflow: 'scroll'}} className="slider__card">
                                            <div style={{overflow: 'scroll'}} className="slider__card__header">
                                            ...
                                            <div style={{overflow: 'scroll'}} className="slider__card__body">
